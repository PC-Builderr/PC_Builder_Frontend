...
export const CASE_API_URL: string = `${process.env.REACT_APP_API_URL}/case`
export const CPU_API_URL: string = `${process.env.REACT_APP_API_URL}/cpu`
export const GPU_API_URL: string = `${process.env.REACT_APP_API_URL}/gpu`
export const STORAGE_API_URL: string = `${process.env.REACT_APP_API_URL}/storage`
